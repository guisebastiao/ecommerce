...
export const ProductDetail = ({ product }: ProductDetailProps) => {
  return (
    <div className="space-y-3">
      ...
      <p className="pl-4 text-sm max-w-[500px]">
        Sua avaliação contribui diretamente para refletir a qualidade percebida
        do produto em aspectos como desempenho, preço e usabilidade.
      </p>
      <Dialog>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Escolha entre 1 a 5 estrelas para avaliar esse produto
            </DialogDescription>
          </DialogHeader>
          <CreateReview />
        </DialogContent>
      ...
      <div className="flex items-end gap-1 pl-4">
        ...
        <span className="text-xs mb-1 tracking-wide">
